    ...
    return (
        <Layout>
            <div className={indexStyles.home}>
                ...
                <div className={`${indexStyles.home__text} ${indexStyles.home__text__1}`}>“Un cane sa ascoltare e sa persino leggere. Non i libri, quelli sono capaci tutti tranne lui. <span>Il cane sa leggere il cuore dell’uomo</span>.”(Fabrizio Caramagna)</div>
